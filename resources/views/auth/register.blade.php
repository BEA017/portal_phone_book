...
{{--Роль --}}
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="role" id="struct-select"  >
                                        <option value="admin"> Администратор структуры</option>
...
{{-- Отдел--}}
                        <div class="row mb-3">
                            <label for="struct_id" class="col-md-4 col-form-label text-md-end">{{ __('Отдел') }}</label>

                            <div class="col-md-6">

                                <select name="struct_id" id="struct-select"  >
